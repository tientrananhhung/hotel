        ...
        <v-dialog v-model="dialog" persistent max-width="700">
            ...
            <v-card>
                        ...
                        <v-layout wrap>
                            ...
                            <v-flex xs12 sm12 md12>
                                <v-menu ref="menu1" :close-on-content-click="false" v-model="menu" :nudge-right="40" lazy transition="scale-transition" offset-y full-width max-width="290px" min-width="290px">
                                    <v-text-field color="light-blue darken-1" slot="activator" v-model="dateFormatted" label="Ngày Sinh" hint="MM/DD/YYYY format" persistent-hint prepend-icon="event" @blur="date = parseDate(dateFormatted)"></v-text-field>
                ...
                <v-card-actions>
                    ...
                    <v-btn color="blue darken-1" flat @click.native="setinfor()">Cập Nhật</v-btn>
                </v-card-actions>
            </v-card>
        </v-dialog>
    </v-layout>
